...
def run():
    ...
    try:
        # 1. Prepare Magnitude-Corrected Input
        ...
        # 3. Standardized Output Statistics for Analyzer
        print("\nOutput Statistics:")
        ...
        # The key verification string that the analyzer looks for
        if not has_nan_gpu:
